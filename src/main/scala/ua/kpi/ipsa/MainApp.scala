...
object MainApp extends App {
  ...
  private type RouteEnv = LocationRoute.Env with HotelStarsRoute.Env with TravelAgentRoute.Env
  val appProgramResource = for {
    ...
    res <- (Server.port(port) ++ Server.app {
             ...
             val swaggerEndpoints = LocationRoute.swaggerEndpoints ++ HotelStarsRoute.swaggerEndpoints ++ TravelAgentRoute.swaggerEndpoints
